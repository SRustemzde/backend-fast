...
async def register_user(user_in: UserCreate):
    ...
    return UserPublic(
        ...
        preferences=created_user.preferences.model_dump() if hasattr(created_user.preferences, 'model_dump') else created_user.preferences,
        is_verified=created_user.is_verified,
        is_active=created_user.is_active,
        security=created_user.security.model_dump() if hasattr(created_user.security, 'model_dump') else created_user.security,
